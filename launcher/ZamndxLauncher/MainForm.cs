...
internal sealed class MainForm : Form
{
    ...
    internal MainForm()
    {
        ...
        Controls.Add(Theme.Label(
            ...
            48, 38, 500, 24, 11, Theme.Muted, FontStyle.Bold));
        Controls.Add(Theme.Label("DX", 46, 63, 150, 74, 42, Theme.Lime, FontStyle.Bold));
        Controls.Add(Theme.Label(
            "Analog movement. Twin-stick shooting. Bigger hitboxes.",
            50, 139, 560, 30, 12, Theme.Text));

        var card = new Panel
        {
            Location = new Point(48, 193),
        ...
        _status = Theme.Label("Checking controller...", 49, 473, 620, 22, 9.5f, Theme.Muted);
